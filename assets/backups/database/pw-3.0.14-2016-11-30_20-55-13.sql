# --- WireDatabaseBackup {"time":"2016-11-30 20:55:13","user":"exception","dbName":"pw","description":"Automatic backup made by ProcessWireUpgrade before upgrading from 3.0.14 to 3.0.42.","tables":[],"excludeTables":[],"excludeCreateTables":[],"excludeExportTables":[]}
...
INSERT INTO `session_login_throttle` (`name`, `attempts`, `last_attempt`) VALUES('exception', '1', '1480535630');
