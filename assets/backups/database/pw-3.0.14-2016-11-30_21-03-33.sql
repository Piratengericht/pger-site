# --- WireDatabaseBackup {"time":"2016-11-30 21:03:33","user":"exception","dbName":"pw","description":"Automatic backup made by ProcessWireUpgrade before upgrading from 3.0.14 to 3.0.42.","tables":[],"excludeTables":[],"excludeCreateTables":[],"excludeExportTables":[]}
