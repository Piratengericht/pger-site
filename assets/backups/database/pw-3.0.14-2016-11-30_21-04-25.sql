# --- WireDatabaseBackup {"time":"2016-11-30 21:04:25","user":"exception","dbName":"pw","description":"Automatic backup made by ProcessWireUpgrade before upgrading from 3.0.14 to 3.0.42.","tables":[],"excludeTables":[],"excludeCreateTables":[],"excludeExportTables":[]}
...
# --- /WireDatabaseBackup {"numTables":36,"numCreateTables":36,"numInserts":1236,"numSeconds":1}